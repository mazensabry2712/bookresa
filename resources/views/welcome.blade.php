                            ...
                            <div class="p-4 sm:p-6">
                                <div class="flex items-end justify-between gap-4">
                                    <div>
                                        ...
                                        <p class="mt-2 text-base font-extrabold text-slate-900 dark:text-white">{{ __('app.home_ui.preview_service_1') }}</p>
                                        <p class="mt-1 text-xs text-slate-400">{{ __('app.home_ui.preview_service_meta') }}</p>
                                    </div>
                                ...
                                <div>
                                    <div class="flex items-center justify-between">
                                        <p class="text-xs font-semibold text-slate-400">{{ __('app.home_ui.preview_time_label') }}</p>
